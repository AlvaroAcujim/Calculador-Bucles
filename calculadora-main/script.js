...
document.querySelector('.buttons-container').addEventListener('click', (e) => {
    ...
    if (e.target.classList.contains('btn')) {
        ...
        switch(operacion){
            case 'sumar': console.log('La suma de los numeros es: ' +(numero1 + numero2));
            break;
            case 'restar': console.log('La resta de los numeros es: ' +(numero1 - numero2));
            break;
            case 'multiplicar': console.log('La multiplicación de los números es: ' +(numero1 * numero2));
            break;
            case 'dividir': numero2 == 0 ? console.log("no se puede dividir entre 0") : console.log('La división de los números es: ' +(numero1 / numero2));
        }
    }
});
